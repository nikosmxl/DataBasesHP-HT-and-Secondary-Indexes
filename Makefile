...
stat:
	...
	gcc -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/statistics_main.c ./src/record.c ./src/statistics.c ./src/hp_file.c ./src/sht_table.c ./src/ht_table.c -lbf -o ./build/statistics_main -O2
